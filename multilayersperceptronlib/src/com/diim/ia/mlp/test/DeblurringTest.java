...
public class DeblurringTest 
{
	...
	public static void main(String[] args) 
	{
		...
		while(/*(error > accouracy) && */(i < maxit))
		{
			...
			double[] inputs = ImageProcessing.loadImage("D:/IA/mlp-java-master/img/deblur/set2/"+(i%nimages)+"_blur.png", sizex, sizey, false);
			...
			double[] output = ImageProcessing.loadImage("D:/IA/mlp-java-master/img/deblur/set2/"+(i%nimages)+".png", sizex, sizey, false);
		...
		/* Test */
		double[] inputs = ImageProcessing.loadImage("D:/IA/mlp-java-master/img/deblur/set2/5_blur.png", sizex, sizey, false);
		double[] output = net.execute(inputs);

		ImageProcessing.saveImage("D:/IA/mlp-java-master/img/deblur/set2/test_unblurred.png", output, sizex, sizey, false);
